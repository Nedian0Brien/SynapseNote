...
import { GraphCardView, GraphSettingsPanel } from './GraphOverlays.jsx';
import { useInjectedGraph } from './useInjectedGraph';
...
export function GraphView({ graphData, onOpenNode, refreshKey }) {
  const { nodes, edges, stats, loading, error, refetch } = useInjectedGraph({ graphData, refreshKey });
      ...
      <div className={`shell${chatDocked ? ' chat-docked' : ''}`} id="shell">
        ...
        {showSettings && (
          <GraphSettingsPanel
            ...
            onUpdateSetting={updateGraphSetting}
          />
        )}

        <GraphCardView
          cardModeNode={cardModeNode}
          cardNodes={cardNodes}
          nodeMeta={nodeMeta}
