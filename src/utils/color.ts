export enum ColorEnum {
  Tint1 = 'synapsenote_theme_color_tint1',
  Tint2 = 'synapsenote_theme_color_tint2',
  Tint3 = 'synapsenote_theme_color_tint3',
  Tint4 = 'synapsenote_theme_color_tint4',
  Tint5 = 'synapsenote_theme_color_tint5',
  Tint6 = 'synapsenote_theme_color_tint6',
  Tint7 = 'synapsenote_theme_color_tint7',
  Tint8 = 'synapsenote_theme_color_tint8',
  Tint9 = 'synapsenote_theme_color_tint9',
  Tint10 = 'synapsenote_theme_color_tint10',
  Tint11 = 'synapsenote_theme_color_tint11',
  Tint12 = 'synapsenote_theme_color_tint12',
  Tint13 = 'synapsenote_theme_color_tint13',
  Tint14 = 'synapsenote_theme_color_tint14',
...
export enum GradientEnum {
  gradient1 = 'synapsenote_theme_color_gradient1',
  gradient2 = 'synapsenote_theme_color_gradient2',
  gradient3 = 'synapsenote_theme_color_gradient3',
  gradient4 = 'synapsenote_theme_color_gradient4',
  gradient5 = 'synapsenote_theme_color_gradient5',
  gradient6 = 'synapsenote_theme_color_gradient6',
  gradient7 = 'synapsenote_theme_color_gradient7',
  gradient8 = 'synapsenote_theme_color_gradient8',
  gradient9 = 'synapsenote_theme_color_gradient9',
  gradient10 = 'synapsenote_theme_color_gradient10',
}

export const colorMap = {
  [ColorEnum.Tint1]: 'var(--palette-bg-color-14)',
  [ColorEnum.Tint2]: 'var(--palette-bg-color-16)',
  [ColorEnum.Tint3]: 'var(--palette-bg-color-18)',
  [ColorEnum.Tint4]: 'var(--palette-bg-color-2)',
  [ColorEnum.Tint5]: 'var(--palette-bg-color-4)',
  [ColorEnum.Tint6]: 'var(--palette-bg-color-6)',
  [ColorEnum.Tint7]: 'var(--palette-bg-color-8)',
  [ColorEnum.Tint8]: 'var(--palette-bg-color-10)',
  [ColorEnum.Tint9]: 'var(--palette-bg-color-12)',
  [ColorEnum.Tint10]: 'var(--palette-bg-color-20)',
  [ColorEnum.Tint11]: 'var(--palette-bg-color-15)',
  [ColorEnum.Tint12]: 'var(--palette-bg-color-17)',
  [ColorEnum.Tint13]: 'var(--palette-bg-color-1)',
  [ColorEnum.Tint14]: 'var(--palette-bg-color-5)',
...
export const gradientMap = {
  [GradientEnum.gradient1]: 'var(--new-gradient1)',
  [GradientEnum.gradient2]: 'var(--new-gradient2)',
  [GradientEnum.gradient3]: 'var(--new-gradient3)',
  [GradientEnum.gradient4]: 'var(--new-gradient4)',
  [GradientEnum.gradient5]: 'var(--new-gradient5)',
  [GradientEnum.gradient6]: 'var(--new-gradient6)',
  [GradientEnum.gradient7]: 'var(--new-gradient7)',
  [GradientEnum.gradient8]: 'var(--new-gradient8)',
  [GradientEnum.gradient9]: 'var(--new-gradient9)',
  [GradientEnum.gradient10]: 'var(--new-gradient10)',
};
