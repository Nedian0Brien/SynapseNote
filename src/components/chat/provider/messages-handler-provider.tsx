...
function useMessagesHandler() {
  ...
  }, [currentUser?.uuid, insertMessage, registerAnimation, currentPromptId, requestInstance, removeMessages, registerFetchSuggestions, createAssistantMessage, messageIds, toast, selectedModelName]);
  ...
  }, [getMessage, setResponseFormatWithId, saveAnswer, messageIds, startFetchSuggestions, removeAssistantMessage, requestInstance, toast, selectedModelName]);
