...
const DOCUMENT_ID_RE = /^doc_[A-Za-z0-9][A-Za-z0-9_-]{0,127}$/;
...
export const DatabaseDocumentIdSchema = z.string().regex(DOCUMENT_ID_RE);
...
export type DatabaseDocumentId = z.infer<typeof DatabaseDocumentIdSchema>;
