---
name: synapsenote-pack-plain-notes
version: "0.18.0"
...
compatibility: "Claude Code, Claude Desktop, Claude Cowork, Claude.ai web. Requires SynapseNote MCP server. Installed project-local by `ok seed --pack plain-notes`."
metadata:
  pack: "plain-notes"
  author: "SynapseNote"
