...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-50 bg-black/10 duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 motion-reduce:data-open:animate-none motion-reduce:data-closed:animate-none motion-reduce:duration-0',
        className,
      )}
      {...props}
    />
...
function SheetContent({
  ...
  sizeMode?: 'default' | 'unconstrained';
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        // Dismissing a sonner toast must not close the sheet beneath it —
