...
import { PagesSuccessSchema, ProblemDetailsSchema } from '@nedian0brien/synapsenote-core';
...
describe('pages envelope (RFC 9457)', () => {
  test('happy path emits flat success body with application/json', async () => {
    ...
    const parsed = PagesSuccessSchema.safeParse(body);
