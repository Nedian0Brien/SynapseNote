...
echo "════════════════════════════════════════════════════════════════════"
echo "  SynapseNote Web v${APP_VERSION:-dev}"
echo "════════════════════════════════════════════════════════════════════"
echo ""
...
if [ -n "${AF_BASE_URL}" ] && [ -z "${SYNAPSENOTE_BASE_URL}" ]; then
  ...
  export SYNAPSENOTE_BASE_URL="${AF_BASE_URL}"
fi
...
if [ -n "${AF_GOTRUE_URL}" ] && [ -z "${SYNAPSENOTE_GOTRUE_BASE_URL}" ]; then
  ...
  export SYNAPSENOTE_GOTRUE_BASE_URL="${AF_GOTRUE_URL}"
fi
...
export SYNAPSENOTE_BASE_URL
export SYNAPSENOTE_GOTRUE_BASE_URL
export SYNAPSENOTE_WS_BASE_URL
