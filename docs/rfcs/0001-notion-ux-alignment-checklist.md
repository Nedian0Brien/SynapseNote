...
This closes UX-902 at the functional compact-inspection layer. Agent invocation
scope, proposal provenance/grouping, retrieval-query explainability, and the
remaining UX-9 items remain open.
