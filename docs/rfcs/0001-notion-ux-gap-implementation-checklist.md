...
- [ ] **NUI-105** Capture a running web and Electron journey for sidebar,
  ...
  remain open. The shared catalog client now uses a bounded three-attempt
  settling window for transient HTTP 409 responses that can occur during the
  short manifest/index transaction window immediately after a new database is
