#!/usr/bin/env bash
#
# Conditional husky setup for SynapseNote.
#
# Why this exists:
#   When OK is checked out as its own clone (Nedian0Brien/SynapseNote), `.git`
...
#   `<parent>/public/synapsenote/.husky/` — clobbering whatever the
...
#
#   When OK is cloned from the public mirror (Nedian0Brien/SynapseNote),
